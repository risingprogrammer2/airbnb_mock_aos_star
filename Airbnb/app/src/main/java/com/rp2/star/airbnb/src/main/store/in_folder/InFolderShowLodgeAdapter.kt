...
import com.rp2.star.airbnb.src.main.search.searching.show.SearchingShowSliderAdapter
import kotlinx.android.synthetic.main.recycler_view_show_lodge.view.*
import me.relex.circleindicator.CircleIndicator3

class InFolderShowLodgeAdapter(val context: Context, val fragment: SearchingShowFragment,
                               val searchingActivityView: SearchingActivityView):
    RecyclerView.Adapter<InFolderShowLodgeAdapter.LodgeViewHolder>(){
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): InFolderShowLodgeAdapter.LodgeViewHolder {
    ...
    override fun onBindViewHolder(
        holder: InFolderShowLodgeAdapter.LodgeViewHolder,
        position: Int
    ) {
